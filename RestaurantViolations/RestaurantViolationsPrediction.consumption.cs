...
namespace RestaurantViolations
{
    ...
    {
        /// <summary>
        /// model input class for RestaurantViolationsPrediction.
        /// </summary>
        ...
        /// <summary>
        /// model output class for RestaurantViolationsPrediction.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("RestaurantViolationsPrediction.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("RiskCategory");
            if (labelColumn == null)
            {
                throw new Exception("RiskCategory column not found. Make sure the name searched for matches the name in the schema.");
            }
