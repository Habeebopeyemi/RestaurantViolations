...
using Microsoft.ML.Data;
    ...
    {
        public const string RetrainConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\opeye\source\repos\RestaurantViolations\RestaurantViolations\RestaurantScores.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"InspectionType",outputColumnName:@"InspectionType")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=24,MinimumExampleCountPerLeaf=17,NumberOfTrees=8,MaximumBinCountPerFeature=154,FeatureFraction=0.934347124817502,LearningRate=0.570776626834717,LabelColumnName=@"RiskCategory",FeatureColumnName=@"Features"}),labelColumnName: @"RiskCategory"))      
